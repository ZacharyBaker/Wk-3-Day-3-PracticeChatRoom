...
app.service('parseService', function($http){
  ...
  //    value that is equal to another object which a key
  //     of text and a value of the message being passed to parse. IE data: {text: yourMessage} 
  // //Also, remember that $http returns a promise. So if you
  //  return the whole $http call (return $http(...)), you 
  //  can then use .then in your controller.
  
  //postData method here
  this.postData = function(messageText){
    return $http ({
      method: 'POST',
      url: 'https://api.parse.com/1/classes/chat',
      data: {text: "el panadero dice: " + messageText}
    });
  };
